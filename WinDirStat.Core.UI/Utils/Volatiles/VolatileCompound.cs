...
namespace WinDirStat.Core.UI.Utils {
	...
	public class VolatileCompound<T> : IVolatile {
		...
		/// <summary>Constructs the default <see cref="VolatileCompound{T}"/>.</summary>
		public VolatileCompound() {
			lockObj = new object();
		}
		/// <summary>Constructs the <see cref="VolatileCompound{T}"/> with the specified value.</summary>
		/// 
		/// <param name="value">The value to use.</param>
		public VolatileCompound(T value) : this() {
			this.value = value;
		}
		/// <summary>Constructs the <see cref="VolatileCompound{T}"/> with the specified lock.</summary>
		/// 
		/// <param name="lockObj">The lock context to use.</param>
		public VolatileCompound(object lockObj) {
			if (lockObj == null)
		...
		/// <summary>Constructs the <see cref="VolatileCompound{T}"/> with the specified value and lock.</summary>
		/// 
		/// <param name="value">The value to use.</param>
		/// <param name="lockObj">The lock context to use.</param>
		public VolatileCompound(T value, object lockObj) : this(lockObj) {
			this.value = value;
		}
		...
		public T Value { get { lock (lockObj) return value; } }
		...
		#region VolatileCompound Operators
		...
		/// <summary>Gets the <see cref="T"/> of the <see cref="VolatileCompound{T}"/>.</summary>
		public static implicit operator T(VolatileCompound<T> value) {
			return value.Value;
		}
